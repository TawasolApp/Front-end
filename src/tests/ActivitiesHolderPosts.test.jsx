...
vi.mock('../pages/Feed/MainFeed/FeedPosts/PostCard/Activities/LikeButton', () => ({
  default: ({ initReactValue, onChange }) => (
    <div data-testid="like-button" data-init-react-value={initReactValue} data-on-change={!!onChange}>
      Like Button
    </div>
  )
}));

vi.mock('../pages/Feed/MainFeed/FeedPosts/PostCard/Activities/CommentButton', () => ({
  default: ({ setShowComments }) => (
    <div data-testid="comment-button" data-set-show-comments={!!setShowComments}>
      Comment Button
    </div>
  )
}));

vi.mock('../pages/Feed/MainFeed/FeedPosts/PostCard/Activities/RepostButton', () => ({
  default: () => <div data-testid="repost-button">Repost Button</div>
}));

vi.mock('../pages/Feed/MainFeed/FeedPosts/PostCard/Activities/SendButton', () => ({
