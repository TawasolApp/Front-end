...
describe("FeedContainer", () => {
  ...
  it("applies responsive width classes to the left sidebar", () => {
    ...
    const leftSidebarContainer = container.querySelector(
  ...
  it("has proper border and background classes for card containers", () => {
    ...
    const leftSidebarCard = container.querySelector(
      ".bg-cardBackground.rounded-lg.border.border-cardBorder",
    );
    expect(leftSidebarCard).toBeInTheDocument();

    // Check right sidebar card styling
    const rightSidebarCard = container.querySelector(
      "aside .bg-cardBackground.rounded-lg.p-4.border.border-cardBorder",
    );
