...
describe("ActorHeader Component", () => {
  ...
  it("renders user information correctly", () => {
    ...
    expect(
      screen.getByText("Software Engineer at Tech Company"),
    ).toBeInTheDocument();
  ...
  it("truncates author bio when it exceeds 47 characters", () => {
    const longBioProps = {
      ...defaultProps,
      authorBio:
        "This is a very long author bio that should be truncated because it exceeds 47 characters limit",
    };
    ...
    expect(
      screen.getByText(/This is a very long author bio that should be t\.\.\./),
    ).toBeInTheDocument();
  });
  ...
  it("shows private visibility icon when visibility is not Public", () => {
    renderWithRouter(
      <ActorHeader {...defaultProps} visibility="Connections" />,
    );
