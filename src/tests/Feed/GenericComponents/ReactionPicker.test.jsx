...
vi.mock("../../../pages/Feed/GenericComponents/reactionIcons", () => ({
  default: {
    Like: {
      Icon: (props) => (
        <div data-testid="like-icon" className={props.className}>
          LikeIcon
        </div>
      ),
      color: "#0a66c2",
    ...
    Celebrate: {
      Icon: (props) => (
        <div data-testid="celebrate-icon" className={props.className}>
          CelebrateIcon
        </div>
      ),
      color: "#44712e",
    ...
    Support: {
      Icon: (props) => (
        <div data-testid="support-icon" className={props.className}>
          SupportIcon
        </div>
      ),
      color: "#715e86",
