...
React.useState = (initialValue) => {
  ...
  if (initialValue === null && mockMentionState.current !== undefined) {
    return [
      mockMentionState.current,
      (val) => {
        mockMentionState.current = val;
      },
    ];
  }
...
describe("TextEditor Component", () => {
  ...
  it("shows user dropdown when typing @", async () => {
    ...
    const container =
      screen.getByPlaceholderText("Write something...").parentNode;
    container.innerHTML += `
  ...
  it("hides dropdown when typing invalid characters after @", async () => {
    ...
    const { rerender } = render(<TextEditor {...defaultProps} text="@" />);
    ...
    rerender(<TextEditor {...defaultProps} text="@ " />);
  ...
  it("uses the externalTextareaRef when provided", () => {
    ...
    render(<TextEditor {...defaultProps} externalTextareaRef={externalRef} />);
  ...
  it("applies custom rows and style when provided", () => {
    ...
    render(<TextEditor {...defaultProps} rows={5} style={customStyle} />);
