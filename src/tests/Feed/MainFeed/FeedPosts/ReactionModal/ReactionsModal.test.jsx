...
vi.mock('@mui/icons-material/ArrowDropDown', () => ({
  default: () => <span data-testid="arrow-dropdown-icon">ArrowDropDownIcon</span>
}));
    ...
    default: {
      ...
      Insightful: {
        Icon: (props) => {
          ...
          return (
            <span 
              data-testid={isTabIcon ? "tab-insightful-icon" : "reaction-insightful-icon"} 
              className={props.className}
              style={props.style}
            >
              InsightfulIcon
      ...
      Celebrate: {
        Icon: (props) => {
          ...
          return (
            <span 
              data-testid={isTabIcon ? "tab-celebrate-icon" : "reaction-celebrate-icon"} 
              className={props.className}
              style={props.style}
            >
              CelebrateIcon
