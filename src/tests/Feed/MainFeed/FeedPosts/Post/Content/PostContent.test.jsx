...
vi.mock('../../../../../../pages/Feed/MainFeed/FeedPosts/Post/Content/TextContent/TextContent', () => ({
  default: ({ reposted }) => (
    <div data-testid="text-content" data-reposted={reposted ? 'true' : 'false'}>
      Text Content Mock
    </div>
  )
}));

vi.mock('../../../../../../pages/Feed/MainFeed/FeedPosts/Post/Content/MediaContent/MediaDisplay', () => ({
