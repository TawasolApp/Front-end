...
describe('TextContent Component', () => {
  ...
  it('renders regular post content when reposted is false', () => {
    ...
    expect(screen.getByTestId('text-content')).toHaveTextContent('Regular post content');
  ...
  it('renders reposted content when reposted is true', () => {
    ...
    expect(screen.getByTestId('text-content')).toHaveTextContent('Reposted content');
