...
vi.mock('../../../../../pages/Feed/MainFeed/FeedPosts/Post/MediaCarousel/MediaCarousel', () => ({
...
describe('PostModal Component', () => {
  ...
  it('passes correct mediaIndex to MediaCarousel', () => {
    ...
    expect(mediaCarousel).toHaveTextContent(`Media index: ${initialMediaIndex}`);
  });
  ...
  it('calls handleClosePostModal when clicking the backdrop', () => {
    ...
    const backdrop = screen.getByTestId('media-carousel').parentElement.parentElement.parentElement;
  ...
  it('shows the reactions modal when showLikes is true', () => {
    ...
    expect(screen.getByTestId('api-url')).toHaveTextContent(`/posts/reactions/${defaultPost.id}`);
