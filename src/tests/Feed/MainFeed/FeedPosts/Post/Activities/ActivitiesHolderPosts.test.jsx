...
vi.mock(
  "../../../../../../pages/Feed/MainFeed/FeedPosts/Post/Activities/LikeButton",
  () => ({
...
vi.mock(
  "../../../../../../pages/Feed/MainFeed/FeedPosts/Post/Activities/CommentButton",
  () => ({
...
vi.mock(
  "../../../../../../pages/Feed/MainFeed/FeedPosts/Post/Activities/RepostButton",
  () => ({
...
vi.mock(
  "../../../../../../pages/Feed/MainFeed/FeedPosts/Post/Activities/SendButton",
  () => ({
