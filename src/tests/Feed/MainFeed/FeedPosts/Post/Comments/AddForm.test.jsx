...
describe('AddForm Component', () => {
  ...
  it('renders with edit comment type correctly', () => {
    ...
    customRender(<AddForm {...defaultProps} type="Edit Comment" close={closeHandler} />);
  ...
  it('shows loading state during submission', async () => {
    ...
    customRender(<AddForm 
      {...defaultProps} 
      handleAddFunction={delayedHandleAdd}
    />);
  ...
  it('prevents submission when text is empty', async () => {
    ...
    customRender(<AddForm {...defaultProps} handleAddFunction={handleAddFunction} />);
  ...
  it('handles submission errors gracefully', async () => {
    ...
    const errorHandleAdd = vi.fn().mockRejectedValue(new Error('Submission failed'));
    
    customRender(<AddForm 
      {...defaultProps} 
      handleAddFunction={errorHandleAdd}
    />);
  ...
  it('displays Edit Reply text with Edit Reply type', () => {
    customRender(<AddForm {...defaultProps} type="Edit Reply" initialText="Some text" />);
    expect(screen.getByText('Edit Reply')).toBeInTheDocument();
  });

  it('displays Reply text with Reply type', () => {
    customRender(<AddForm {...defaultProps} type="Reply" initialText="Some text" />);
    expect(screen.getByText('Reply')).toBeInTheDocument();
  });
});