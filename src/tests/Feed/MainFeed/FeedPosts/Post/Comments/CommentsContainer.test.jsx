...
vi.mock('@mui/icons-material/OpenInFull', () => ({
  default: () => <div data-testid="load-more-button"><span>Load more comments</span></div>
}));
...
vi.mock('../../../../../../pages/Feed/MainFeed/FeedPosts/Post/Comments/AddForm', () => ({
  default: ({ handleAddFunction, type }) => (
    <div data-testid="add-form">
      ...
      <button onClick={() => handleAddFunction('New comment', [])} data-testid="add-comment-button">
        Add Comment
      </button>
    </div>
  )
...
vi.mock('../../../../../../pages/Feed/MainFeed/FeedPosts/Post/Comments/Comment', () => ({
  default: ({ comment }) => (
