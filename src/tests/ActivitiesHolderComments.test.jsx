...
vi.mock('../pages/Feed/GenericComponents/reactionIcons', () => ({
  default: {
    like: {
      Icon: ({ className }) => <div data-testid="like-icon" className={className}>Like Icon</div>,
      color: 'blue',
      label: 'Like'
    },
    celebrate: {
      Icon: ({ className }) => <div data-testid="celebrate-icon" className={className}>Celebrate Icon</div>,
      color: 'yellow',
      label: 'Celebrate'
    },
    support: {
      Icon: ({ className }) => <div data-testid="support-icon" className={className}>Support Icon</div>,
      color: 'purple',
      label: 'Support'
    },
    insightful: {
      Icon: ({ className }) => <div data-testid="insightful-icon" className={className}>Insightful Icon</div>,
      color: 'green',
      label: 'Insightful'
    }
  }
