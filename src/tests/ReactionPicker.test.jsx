...
vi.mock('../pages/Feed/GenericComponents/reactionIcons', () => ({
  default: {
    like: {
      Icon: ({ className }) => <div data-testid="like-icon" className={className}>👍</div>,
      color: 'blue',
      label: 'Like'
    },
    celebrate: {
      Icon: ({ className }) => <div data-testid="celebrate-icon" className={className}>🎉</div>,
      color: 'yellow',
      label: 'Celebrate'
    },
    support: {
      Icon: ({ className }) => <div data-testid="support-icon" className={className}>🙌</div>,
      color: 'purple',
      label: 'Support'
    }
  }
...
describe('ReactionPicker Component', () => {
  ...
  it('shows tooltip when hovering over a reaction', () => {
    ...
    const visibleTooltipElement = container.querySelector('div[class*="opacity-100"]');
