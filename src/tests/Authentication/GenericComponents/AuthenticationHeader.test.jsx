...
describe("AuthenticationHeader", () => {
  ...
  describe("Styling changes", () => {
    it("has different styling when hideButtons is true", () => {
      const { container: hiddenContainer } = render(<AuthenticationHeader hideButtons={true} />);
    ...
    it("has standard styling when hideButtons is false", () => {
      const { container: standardContainer } = render(<AuthenticationHeader hideButtons={false} />);
