...
vi.mock("@mui/material/Avatar", () => ({
  default: ({ src, sx, className }) => (
    <div data-testid="mock-avatar" className={className} style={sx}>
...
vi.mock("../pages/Feed/MainFeed/SharePost/TextModal", () => ({
  default: ({
    ...
    <div data-testid="mock-text-modal">
      ...
      <button data-testid="close-modal-btn" onClick={() => setIsModalOpen()}>
        Close
      </button>
      <button
        data-testid="share-btn"
        onClick={() => {
          handleSubmitFunction("Test post content", "Anyone");
          setIsModalOpen();
        }}
      >
        Share Post
