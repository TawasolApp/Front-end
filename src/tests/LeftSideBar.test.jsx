...
vi.mock('@mui/icons-material/KeyboardArrowDown', () => ({
  default: ({ className }) => <div data-testid="arrow-down-icon" className={className}>KeyboardArrowDownIcon</div>
}));

vi.mock('@mui/icons-material/KeyboardArrowUp', () => ({
  default: ({ className }) => <div data-testid="arrow-up-icon" className={className}>KeyboardArrowUpIcon</div>
}));
...
describe('LeftSideBar Component', () => {
  ...
  it('renders user profile information correctly', () => {
    ...
    expect(screen.getByText('Computer Engineering Student at Cairo University')).toBeInTheDocument();
  ...
  it('contains links to user profile and saved items', () => {
    ...
    const savedItemsLink = container.querySelector('a[href="/my-items/saved-posts"]');
  ...
  it('displays the correct background image', () => {
    ...
    expect(backgroundDiv.style.backgroundImage).toContain('profile-displaybackgroundimage-shrink');
  });
});