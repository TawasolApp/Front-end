    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="block lg:hidden">
        <div className="p-6 sm:p-8 flex flex-col items-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-normal text-gray-600 mb-8 sm:mb-12 text-center">
      ...
      <div className="hidden lg:flex min-h-screen items-center justify-center p-12">
        ...
        <div className="flex-1 max-w-2xl mr-12">
          <h1 className="text-5xl xl:text-6xl font-normal text-gray-600 mb-12">
            Welcome to your professional community
          </h1>
