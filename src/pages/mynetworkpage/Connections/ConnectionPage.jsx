          ...
          <div className="mt-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full sm:w-48 p-2 pl-10 border border-cardBorder rounded-lg focus:outline-none focus:border-buttonSubmitEnable text-sm font-semibold bg-cardBackground text-textPlaceholder"
              />
              <svg
