describe('Company Creation', () => {
    ...
    it.skip('Creates a Job', () => {
        ...
        cy.getJobDescription().type('We are looking for an experienced software engineer to join our team. The ideal candidate will have strong expertise in React, Node.js, and cloud technologies.');
