describe("open news feed", () => {
  ...
  describe("Post interactions With attachments", () => {
    it("Creates a Post", () => {
      cy.getCreatePost().click();
      cy.getCreatePostInput()
        .click()
        .type("This is a test post with attachments");
      cy.getAddMediaButton().click();
      cy.get('input[type="file"]').selectFile("cypress/fixtures/t-stat.png", {
        force: true,
      });
      ...
      cy.getPost()
        .first()
        .should("contain", "This is a test post with attachments");
    });
    ...
    it("Deletes a Post ", () => {
      ...
      cy.getPost()
        .first()
        .should("not.contain", "This is a test post with attachments");
    });
    ...
    it("Edits a Post removing attachments", () => {
      ...
      cy.getCreatePostInput()
        .clear()
        .type("This is an edited test post without an attachments");
      ...
      cy.getPost()
        ...
        .should(
          "contain",
          "This is an edited test post without an attachments",
        );
    });
