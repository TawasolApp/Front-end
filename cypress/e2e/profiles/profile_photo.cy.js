describe("adds, updates, deletes profile photo", () => {
  ...
  it("interacts with profile photo", () => {
    ...
    cy.get('img[alt="Profile"]')
      .invoke("attr", "src")
      .should("include", "src/assets/images/defaultProfilePicture.png");
    ...
    // get new image
    cy.get('img[alt="Profile"]').invoke("attr", "src").as("newSrc");
    ...
    // get newer image
    cy.get('img[alt="Profile"]').invoke("attr", "src").as("newerSrc");
