describe("adds, updates, deletes cover photo", () => {
    ...
    it("interacts with cover photo", () => {
      ...
      cy.get('img[alt="Cover"]').invoke('attr', 'src').should('include', 'src/assets/images/defaultCoverPhoto.png');
      ...
      // update cover photo
      cy.get('.w-full.shadow > :nth-child(1) > .relative > .absolute > .w-8').click();
      cy.wait(2000);
