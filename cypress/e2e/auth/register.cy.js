...
//   });
  ...
  it("Does not register due to invalid email", () => {
    ...
    cy.get('.text-red-500').should('have.text', 'Please enter a valid email address.');
  ...
  it("Does not register due to invalid password", () => {
    ...
    cy.get('.text-red-500').should('have.text', 'Password must be at least 6 characters long');
    cy.url().should('not.include', 'auth/signup/name');
  });
  ...
  it("Does not register due to invalid name", () => {
    ...
    cy.get('.text-red-500').should('have.text', 'Please enter your first name.');
